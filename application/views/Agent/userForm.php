...
<section class="content">
		<div class="container-fluid">
				<ol class="breadcrumb breadcrumb-bg-pink">
						<li><a href="<?=base_url();?>agent/manageuser">จัดการ User</a></li>
						<li class="active"><a href="javascript:void(0);">ฟอร์มจัดการ User</a></li>
				</ol>
													...
													<div class="col-md-4">
															<div class="input-group">
																	...
																	<div class="form-line disabled">
																			<input type="text" id="txtid" name="txtid" class="form-control" placeholder="ID" disabled value="<?php if (count($userData) > 0) { echo $userData[0]["userID"]; } ?>">
																	</div>
															...
															<div class="input-group">
																	...
																	<div class="form-line">
																			<input type="text" id="txtname" name="txtname" class="form-control" placeholder="ชื่อ" value="<?php if (count($userData) > 0) { echo $userData[0]["name"]; } ?>">
																	</div>
															...
															<div class="input-group">
																	...
																	<div class="form-line">
																			<input type="text" id="txtsurname" name="txtsurname" class="form-control" placeholder="นามสกุล" value="<?php if (count($userData) > 0) { echo $userData[0]["surname"]; } ?>">
																	</div>
															...
															<div class="input-group">
																	...
																	<div class="form-line">
																			<input type="text" id="txttel" name="txttel" class="form-control" placeholder="เบอร์โทรศัพท์" value="<?php if (count($userData) > 0) { echo $userData[0]["telephone"]; } ?>">
																	</div>
															...
															<div class="input-group">
																	...
																	<div class="form-line">
																			<input type="text" id="txtusername" name="txtusername" class="form-control" placeholder="Username" value="<?php if (count($userData) > 0) { echo $userData[0]["username"]; } ?>">
																	</div>
															...
															<div class="input-group">
																	...
																	<div class="form-line">
																			<input type="password" id="txtpassword" name="txtpassword" class="form-control" placeholder="Password" value="<?php if (count($userData) > 0) { echo $userData[0]["password"]; } ?>">
																	</div>
															...
															<div class="input-group">
																	...
																	<div class="form-line">
																			<input type="password" id="txtrepassword" name="txtrepassword" class="form-control" placeholder="Re-Password" value="<?php if (count($userData) > 0) { echo $userData[0]["password"]; } ?>">
																	</div>
